...
async function handleChatImplementation(
  ...
  // absent from the chat catalog (dual-purpose ids like codex/gpt-5.5 pass through,
  // while pure image models like flux/chatgpt-web/gpt-5.3-instant are still rejected).
