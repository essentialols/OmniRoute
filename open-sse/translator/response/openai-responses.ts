...
function emitToolCall(state, emit, tc) {
  ...
  // Also honors any other client-declared custom tool (exec, …) threaded via
  // state.customToolNames — the request side records tools declared `type:"custom"`
  // (#1007 / #4862) so the response side can surface their returned tool_calls as
  // custom_tool_call items too.
